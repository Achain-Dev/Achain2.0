...
class Cluster(object):
    ...
    def __init__(self, walletd=False, localCluster=True, host="localhost", port=8888, walletHost="localhost", walletPort=9899, enableMongo=False
        ...
        self.eosioAccount=self.defProducerAccounts["actx"]= Account("actx")
    ...
    def bootstrap(totalNodes, prodCount, totalProducers, biosHost, biosPort, walletMgr, onlyBios=False):
        ...
        if not onlyBios:
            ...
            lam = lambda: biosNode.getInfo(exitOnError=True)["head_block_producer"] != "actx"
        ...
        eosioTokenAccount.name="actx.token"
        ...
        eosioRamfeeAccount.name="actx.ramfee"
        ...
        eosioStakeAccount.name="actx.stake"
