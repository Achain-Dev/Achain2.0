...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( act, act, newaccount );
   SET_APP_HANDLER( act, act, setcode );
   SET_APP_HANDLER( act, act, setabi );
   SET_APP_HANDLER( act, act, updateauth );
   SET_APP_HANDLER( act, act, deleteauth );
   SET_APP_HANDLER( act, act, linkauth );
   SET_APP_HANDLER( act, act, unlinkauth );
/*
...
//add func get_subjective_cpu_leeway to get subjective_cpu_leeway
