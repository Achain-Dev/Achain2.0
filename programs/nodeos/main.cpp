...
int main(int argc, char** argv)
{
   try {
      ...
      app().set_default_data_dir(root / "achain" / nodeos::config::node_executable_name / "data" );
      app().set_default_config_dir(root / "achain" / nodeos::config::node_executable_name / "config" );
