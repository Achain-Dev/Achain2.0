...
BOOST_AUTO_TEST_CASE( activate_preactivate_feature ) try {
   ...
   BOOST_CHECK_EXCEPTION( c.set_code( config::system_account_name, contracts::act_bios_wasm() ),
   ...
   c.set_code( config::system_account_name, contracts::act_bios_wasm() );
   c.set_abi( config::system_account_name, contracts::act_bios_abi().data() );
